...
As of April 15, I am rewriting it in C# in order to develop a substantial project in C#, take advantage of the .NET Framework's Task Parallel Library, and make optimization improvements outlined below. See the C# branch for progress.
